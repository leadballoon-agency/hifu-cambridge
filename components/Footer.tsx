        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-10">
          <div>
            ...
            <p className="text-sm sm:text-base text-neutral-400 leading-relaxed">
              Expert HIFU non-surgical facelift in Cambridge
            </p>
            <p className="text-sm text-neutral-400 mt-2 leading-relaxed">
              Natural enhancements by qualified aesthetic practitioner
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm sm:text-base text-neutral-400">
              ...
              <li><a href="https://www.instagram.com/diluxe.aesthetics" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Instagram</a></li>
            </ul>
          </div>
        </div>

        <div className="border-t border-neutral-800 mt-8 pt-8 text-center text-neutral-400">
          <p className="text-sm sm:text-base mb-2">&copy; 2025 Diluxe Aesthetics Cambridge. All rights reserved.</p>
